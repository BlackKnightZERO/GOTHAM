...
printf("press A for BatCar to move Left\n");
printf("press D for BatCar to move Right\n");
printf("press W to turn on BatSignal\n");
printf("press S to turn off BatSignal\n");
printf("press E for engage weapon system\n");
printf("press Q for disengage weapon system\n");
printf("press R for Weapon Fire\n");
printf("press F for No Fire\n");
printf("press LeftMouse/RightMouse for Rotation of Turbine\n");
